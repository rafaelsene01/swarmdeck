...
mod window_state;
pub use window_state::{set_window_state, window_state};
...
const MIGRATIONS: &[(i64, &str)] = &[
    ...
    (13, include_str!("migrations/013_window_state.sql")),
    (14, include_str!("migrations/014_provider_prefs.sql")),
];
